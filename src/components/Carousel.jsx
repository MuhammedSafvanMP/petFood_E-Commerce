...
export default function Carousal() {
  ...
  return (
    ...
    <section id="carouselExampleIndicators" style={{ background: '#F9F3EC' }} className="carousel slide" data-bs-ride="carousel">
              ...
              <div className="swiper-slide py-5">
                    <div className="row banner-content align-items-center">
                      ...
                      <div className="content-wrapper col-md-7 p-5 mb-5">
                        ...
                        <h2 className="banner-title display-1 fw-normal"> {caro.title.black} <span className="text-primary"> {caro.title.yellow} </span></h2>
