...
const handleADD = (e) => {
  ...
  return (
    ...
    <div className="row">
      ...
      <div className="mb-3">
        <input type="text" className="form-control" id="title" name="title" placeholder="Product name" required />
      </div>

      <div className="mb-3">
        <input type="number" className="form-control" id="price" name="price" placeholder="Product price" required />
      </div>
        ...
        
              {
                ...
                products.map((product) => {
                  return(
                    ...
                    <td className="py-4 align-middle">
                      <div className="total-price">
                        <span className="secondary-font fw-medium">{product.category}</span>
                      </div>
                    </td>
                    <td className="py-4 align-middle">
                      <div className="d-flex align-items-center">
                        <div className="me-4">
                          <button onClick={() => Navigate(`/products/${product.id}`)}  className="btn btn-dark p-3 text-uppercase fs-6 btn-rounded-none w-100">
                        
                          <FaRegEdit />
                         
                          </button>
                        </div>
                        <div className="cart-remove" onClick={() => handleDelete(product.id)}>
